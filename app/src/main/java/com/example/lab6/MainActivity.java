...
////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        MyAdapter transAdapter = new MyAdapter(transData, R.layout.tran_list);
        ...
        Data[] cubeeData = new Data[transNameArray.length];

        for(int j = 0;j < cubeeData.length;j++){
            cubeeData[j] = new Data();
            cubeeData[j].name = cubeeNameArray[j];
            cubeeData[j].photo = cubeePhotoIdArray[j];
        }
